...
###3、星号(*)
> 星号*是常用的通配符，也可以用在搜索中，目前，百度不支持*号搜索指令。比如在Google中搜索：搜索*擎其中的*号代表任何文字，返回的结果就不仅包含“搜索引擎”，还包含了“搜索收擎”，“搜索巨擎”等内容。
...
###Domain
> 用domain命令可以查找跟某一网站相关的信息或反向链接，目前此指令只适用于百度，例如：在百度上提交搜索“domain:www.mahaixiang.cn”，所搜索的结果就的关于www.mahaixiang.cn网站的反向链接。
